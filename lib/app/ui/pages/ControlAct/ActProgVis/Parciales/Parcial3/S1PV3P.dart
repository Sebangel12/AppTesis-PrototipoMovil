...
class S1PV3P extends StatefulWidget {
  @override
  State<S1PV3P> createState() => _S1PV3PState();
}

class _S1PV3PState extends State<S1PV3P> {
  ...
  Future uploadFile() async {
    final path =
        "Programación visual/Tercer parcial/Semana 1/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Programación Visual P3 - S1'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Programación visual/Tercer parcial/Semana 1/$fileName")
                        .putData(file!);
