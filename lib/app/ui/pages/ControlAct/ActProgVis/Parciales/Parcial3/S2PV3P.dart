...
class S2PV3P extends StatefulWidget {
  @override
  State<S2PV3P> createState() => _S2PV3PState();
}

class _S2PV3PState extends State<S2PV3P> {
  ...
  Future uploadFile() async {
    final path =
        "Programación visual/Tercer parcial/Semana 2/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Programación Visual P3 - S2'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Programación visual/Tercer parcial/Semana 2/$fileName")
                        .putData(file!);
