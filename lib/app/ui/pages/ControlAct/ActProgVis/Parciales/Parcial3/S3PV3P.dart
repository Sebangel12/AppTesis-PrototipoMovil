...
class S3PV3P extends StatefulWidget {
  @override
  State<S3PV3P> createState() => _S3PV3PState();
}

class _S3PV3PState extends State<S3PV3P> {
  ...
  Future uploadFile() async {
    final path =
        "Programación visual/Tercer parcial/Semana 3/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Programación Visual P3 - S3'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Programación visual/Tercer parcial/Semana 3/$fileName")
                        .putData(file!);
