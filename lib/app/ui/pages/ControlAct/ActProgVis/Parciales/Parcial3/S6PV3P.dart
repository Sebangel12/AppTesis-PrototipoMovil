...
class S6PV3P extends StatefulWidget {
  @override
  State<S6PV3P> createState() => _S6PV3PState();
}

class _S6PV3PState extends State<S6PV3P> {
  ...
  Future uploadFile() async {
    final path =
        "Programación visual/Tercer parcial/Semana 6/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Programación Visual P3 - S6'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Programación visual/Tercer parcial/Semana 6/$fileName")
                        .putData(file!);
