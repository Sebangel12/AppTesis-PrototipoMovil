...
class S5PV3P extends StatefulWidget {
  @override
  State<S5PV3P> createState() => _S5PV3PState();
}

class _S5PV3PState extends State<S5PV3P> {
  ...
  Future uploadFile() async {
    final path =
        "Programación visual/Tercer parcial/Semana 5/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Programación Visual P3 - S5'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Programación visual/Tercer parcial/Semana 5/$fileName")
                        .putData(file!);
