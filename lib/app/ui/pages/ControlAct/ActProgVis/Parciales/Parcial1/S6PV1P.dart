...
class S6PV1P extends StatefulWidget {
  @override
  State<S6PV1P> createState() => _S6PV1PState();
}

class _S6PV1PState extends State<S6PV1P> {
  ...
  Future uploadFile() async {
    final path =
        "Programación visual/Primer parcial/Semana 6/${pickedFile!.name}"; // ubicacion de almacenar el archivo
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Programación visual/Primer parcial/Semana 6/$fileName")
                        .putData(file!);
