...
class S3PV1P extends StatefulWidget {
  @override
  State<S3PV1P> createState() => _S3PV1PState();
}

class _S3PV1PState extends State<S3PV1P> {
  ...
  Future uploadFile() async {
    final path =
        "Programación visual/Primer parcial/Semana 3/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Programación visual P1 - S3'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Programación visual/Primer parcial/Semana 3/$fileName")
                        .putData(file!);
