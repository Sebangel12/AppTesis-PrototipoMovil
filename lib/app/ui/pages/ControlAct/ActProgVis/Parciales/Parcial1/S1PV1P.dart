...
class S1PV1P extends StatefulWidget {
  @override
  State<S1PV1P> createState() => _S1PV1PState();
}

class _S1PV1PState extends State<S1PV1P> {
  ...
  Future uploadFile() async {
    final path =
        "Programación visual/Primer parcial/Semana 1/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Programación Visual P1 - S1'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Programación visual/Primer parcial/Semana 1/$fileName")
                        .putData(file!);
