...
class S2PV1P extends StatefulWidget {
  @override
  State<S2PV1P> createState() => _S2PV1PState();
}

class _S2PV1PState extends State<S2PV1P> {
  ...
  Future uploadFile() async {
    final path =
        "Programación visual/Primer parcial/Semana 2/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Programación visual P1 - S2'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Programación visual/Primer parcial/Semana 2/$fileName")
                        .putData(file!);
