...
class S4PV1P extends StatefulWidget {
  @override
  State<S4PV1P> createState() => _S4PV1PState();
}

class _S4PV1PState extends State<S4PV1P> {
  ...
  Future uploadFile() async {
    final path =
        "Programación visual/Primer parcial/Semana 4/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Programación visual P1 - S4'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Programación visual/Primer parcial/Semana 4/$fileName")
                        .putData(file!);
