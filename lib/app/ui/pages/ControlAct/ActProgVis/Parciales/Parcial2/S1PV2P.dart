...
class S1PV2P extends StatefulWidget {
  @override
  State<S1PV2P> createState() => _S1PV2PState();
}

class _S1PV2PState extends State<S1PV2P> {
  ...
  Future uploadFile() async {
    final path =
        "Programación visual/Segundo parcial/Semana 1/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Programación visual P2 - S1'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Programación visual/Segundo parcial/Semana 1/$fileName")
                        .putData(file!);
