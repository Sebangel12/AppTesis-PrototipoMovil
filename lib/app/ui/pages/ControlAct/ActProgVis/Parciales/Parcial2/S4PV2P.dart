...
class S4PV2P extends StatefulWidget {
  @override
  State<S4PV2P> createState() => _S4PV2PState();
}

class _S4PV2PState extends State<S4PV2P> {
  ...
  Future uploadFile() async {
    final path =
        "Programación visual/Segundo parcial/Semana 4/${pickedFile!.name}"; // ubicacion de almacenar el archivo
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Programación visual/Segundo parcial/Semana 4/$fileName")
                        .putData(file!);
