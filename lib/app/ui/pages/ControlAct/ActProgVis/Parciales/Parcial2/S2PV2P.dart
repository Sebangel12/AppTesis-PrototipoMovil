...
class S2PV2P extends StatefulWidget {
  @override
  State<S2PV2P> createState() => _S2PV2PState();
}

class _S2PV2PState extends State<S2PV2P> {
  ...
  Future uploadFile() async {
    final path =
        "Programación visual/Segundo parcial/Semana 2/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Programación Visual P2 - S2'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Programación visual/Segundo parcial/Semana 2/$fileName")
                        .putData(file!);
