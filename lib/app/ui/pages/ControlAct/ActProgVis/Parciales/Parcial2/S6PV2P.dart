...
class S6PV2P extends StatefulWidget {
  @override
  State<S6PV2P> createState() => _S6PV2PState();
}

class _S6PV2PState extends State<S6PV2P> {
  ...
  Future uploadFile() async {
    final path =
        "Programación visual/Segundo parcial/Semana 6/${pickedFile!.name}"; // ubicacion de almacenar el archivo
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Programación visual/Segundo parcial/Semana 6/$fileName")
                        .putData(file!);
