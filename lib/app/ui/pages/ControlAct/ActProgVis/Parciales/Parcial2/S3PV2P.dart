...
class S3PV2P extends StatefulWidget {
  @override
  State<S3PV2P> createState() => _S3PV2PState();
}

class _S3PV2PState extends State<S3PV2P> {
  ...
  Future uploadFile() async {
    final path =
        "Programación visual/Segundo parcial/Semana 3/${pickedFile!.name}"; // ubicacion de almacenar el archivo
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Programación visual/Segundo parcial/Semana 3/$fileName")
                        .putData(file!);
