...
class S3FP1P extends StatefulWidget {
  @override
  State<S3FP1P> createState() => _S3FP1PState();
}

class _S3FP1PState extends State<S3FP1P> {
  ...
  Future uploadFile() async {
    final path =
        "Fundamentos de programación/Primer parcial/Semana 3/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Fundamentos de programación P1 - S3'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Fundamentos de programación/Primer parcial/Semana 3/$fileName")
                        .putData(file!);
