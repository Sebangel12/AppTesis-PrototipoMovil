...
class _S4FP1PState extends State<S4FP1P> {
  ...
  Future uploadFile() async {
    final path =
        "Fundamentos de programación/Primer parcial/Semana 4/${pickedFile!.name}"; // ubicacion de almacenar el archivo
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Fundamentos de programación/Primer parcial/Semana 4/$fileName")
                        .putData(file!);
