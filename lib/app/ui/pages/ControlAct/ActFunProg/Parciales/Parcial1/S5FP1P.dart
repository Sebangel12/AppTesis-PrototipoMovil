...
class S5FP1P extends StatefulWidget {
  @override
  State<S5FP1P> createState() => _S5FP1PState();
}

class _S5FP1PState extends State<S5FP1P> {
  ...
  Future uploadFile() async {
    final path =
        "Fundamentos de programación/Primer parcial/Semana 5/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Fundamentos de programación P1 - S5'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Fundamentos de programación/Primer parcial/Semana 5/$fileName")
                        .putData(file!);
