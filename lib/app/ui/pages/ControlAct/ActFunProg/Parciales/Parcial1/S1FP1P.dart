...
class S1FP1P extends StatefulWidget {
  @override
  State<S1FP1P> createState() => _S1FP1PState();
}

class _S1FP1PState extends State<S1FP1P> {
  ...
  Future uploadFile() async {
    final path =
        "Fundamentos de programación/Primer parcial/Semana 1/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Fundamentos de programación P1 - S1'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Fundamentos de programación/Primer parcial/Semana 1/$fileName")
                        .putData(file!);
