...
class _S2FP1PState extends State<S2FP1P> {
  ...
  Future uploadFile() async {
    final path =
        "Fundamentos de programación/Primer parcial/Semana 2/${pickedFile!.name}"; // ubicacion de almacenar el archivo
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Fundamentos de programación/Primer parcial/Semana 2/$fileName")
                        .putData(file!);
