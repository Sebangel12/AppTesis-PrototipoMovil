...
class S5FP2P extends StatefulWidget {
  @override
  State<S5FP2P> createState() => _S5FP2PState();
}

class _S5FP2PState extends State<S5FP2P> {
  ...
  Future uploadFile() async {
    final path =
        "Fundamentos de programación/Segundo parcial/Semana 5/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Fundamentos de programación P2 - S5'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Fundamentos de programación/Segundo parcial/Semana 5/$fileName")
                        .putData(file!);
