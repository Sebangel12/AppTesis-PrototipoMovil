...
class S6FP2P extends StatefulWidget {
  @override
  State<S6FP2P> createState() => _S6FP2PState();
}

class _S6FP2PState extends State<S6FP2P> {
  ...
  Future uploadFile() async {
    final path =
        "Fundamentos de programación/Segundo parcial/Semana 6/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Fundamentos de programación P2 - S6'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Fundamentos de programación/Segundo parcial/Semana 6/$fileName")
                        .putData(file!);
