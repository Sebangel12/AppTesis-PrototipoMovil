...
class S3FP2P extends StatefulWidget {
  @override
  State<S3FP2P> createState() => _S3FP2PState();
}

class _S3FP2PState extends State<S3FP2P> {
  ...
  Future uploadFile() async {
    final path =
        "Fundamentos de programación/Segundo parcial/Semana 3/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Fundamentos de programación P2 - S3'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Fundamentos de programación/Segundo parcial/Semana 3/$fileName")
                        .putData(file!);
