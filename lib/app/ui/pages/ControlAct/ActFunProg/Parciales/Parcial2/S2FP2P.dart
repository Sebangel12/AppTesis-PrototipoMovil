...
class S2FP2P extends StatefulWidget {
  @override
  State<S2FP2P> createState() => _S2FP2PState();
}

class _S2FP2PState extends State<S2FP2P> {
  ...
  Future uploadFile() async {
    final path =
        "Fundamentos de programación/Segundo parcial/Semana 2/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Fundamentos de programación P2 - S2'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Fundamentos de programación/Segundo parcial/Semana 2/$fileName")
                        .putData(file!);
