...
class S1FP2P extends StatefulWidget {
  @override
  State<S1FP2P> createState() => _S1FP2PState();
}

class _S1FP2PState extends State<S1FP2P> {
  ...
  Future uploadFile() async {
    final path =
        "Fundamentos de programación/Segundo parcial/Semana 1/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Fundamentos de programación P2 - S1'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Fundamentos de programación/Segundo parcial/Semana 1/$fileName")
                        .putData(file!);
