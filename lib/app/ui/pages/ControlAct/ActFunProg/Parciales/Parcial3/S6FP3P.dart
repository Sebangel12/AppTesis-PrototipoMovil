...
class S6FP3P extends StatefulWidget {
  @override
  State<S6FP3P> createState() => _S6FP3PState();
}

class _S6FP3PState extends State<S6FP3P> {
  ...
  Future uploadFile() async {
    final path =
        "Fundamentos de programación/Tercer parcial/Semana 6/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Fundamentos de programación P3 - S6'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Fundamentos de programación/Tercer parcial/Semana 6/$fileName")
                        .putData(file!);
