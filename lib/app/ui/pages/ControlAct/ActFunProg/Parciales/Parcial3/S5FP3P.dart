...
class S5FP3P extends StatefulWidget {
  @override
  State<S5FP3P> createState() => _S5FP3PState();
}

class _S5FP3PState extends State<S5FP3P> {
  ...
  Future uploadFile() async {
    final path =
        "Fundamentos de programación/Tercer parcial/Semana 5/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Fundamentos de programación P3 - S5'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Fundamentos de programación/Tercer parcial/Semana 5/$fileName")
                        .putData(file!);
