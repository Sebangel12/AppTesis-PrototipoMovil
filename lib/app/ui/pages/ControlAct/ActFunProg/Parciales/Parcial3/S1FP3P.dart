...
class S1FP3P extends StatefulWidget {
  @override
  State<S1FP3P> createState() => _S1FP3PState();
}

class _S1FP3PState extends State<S1FP3P> {
  ...
  Future uploadFile() async {
    final path =
        "Fundamentos de programación/Tercer parcial/Semana 1/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Fundamentos de programación P3 - S1'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Fundamentos de programación/Tercer parcial/Semana 1/$fileName")
                        .putData(file!);
