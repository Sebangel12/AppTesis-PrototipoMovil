...
class S3FP3P extends StatefulWidget {
  @override
  State<S3FP3P> createState() => _S3FP3PState();
}

class _S3FP3PState extends State<S3FP3P> {
  ...
  Future uploadFile() async {
    final path =
        "Fundamentos de programación/Tercer parcial/Semana 3/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Fundamentos de programación P3 - S3'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Fundamentos de programación/Tercer parcial/Semana 3/$fileName")
                        .putData(file!);
