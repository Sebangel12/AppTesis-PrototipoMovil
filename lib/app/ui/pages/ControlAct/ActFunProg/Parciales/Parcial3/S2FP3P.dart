...
class S2FP3P extends StatefulWidget {
  @override
  State<S2FP3P> createState() => _S2FP3PState();
}

class _S2FP3PState extends State<S2FP3P> {
  ...
  Future uploadFile() async {
    final path =
        "Fundamentos de programación/Tercer parcial/Semana 2/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Fundamentos de programación P3 - S2'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Fundamentos de programación/Tercer parcial/Semana 2/$fileName")
                        .putData(file!);
