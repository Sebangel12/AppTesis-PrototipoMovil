...
class S4PM3P extends StatefulWidget {
  @override
  State<S4PM3P> createState() => _S4PM3PState();
}

class _S4PM3PState extends State<S4PM3P> {
  ...
  Future uploadFile() async {
    final path =
        "Aplicaciónes móviles/Tercer parcial/Semana 4/${pickedFile!.name}"; // ubicacion de almacenar el archivo
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Aplicaciónes móviles/Tercer parcial/Semana 4/$fileName")
                        .putData(file!);
