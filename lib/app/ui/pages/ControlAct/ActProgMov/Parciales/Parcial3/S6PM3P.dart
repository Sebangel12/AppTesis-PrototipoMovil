...
class S6PM3P extends StatefulWidget {
  @override
  State<S6PM3P> createState() => _S6PM3PState();
}

class _S6PM3PState extends State<S6PM3P> {
  ...
  Future uploadFile() async {
    final path =
        "Aplicaciónes móviles/Tercer parcial/Semana 6/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Aplicaciónes móviles P3 - S6'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Aplicaciónes móviles/Tercer parcial/Semana 6/$fileName")
                        .putData(file!);
