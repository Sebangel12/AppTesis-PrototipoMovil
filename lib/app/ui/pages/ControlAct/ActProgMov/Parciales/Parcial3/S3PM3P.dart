...
class S3PM3P extends StatefulWidget {
  @override
  State<S3PM3P> createState() => _S3PM3PState();
}

class _S3PM3PState extends State<S3PM3P> {
  ...
  Future uploadFile() async {
    final path =
        "Aplicaciónes móviles/Tercer parcial/Semana 3/${pickedFile!.name}"; // ubicacion de almacenar el archivo
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Aplicaciónes móviles/Tercer parcial/Semana 3/$fileName")
                        .putData(file!);
