...
class S2PM3P extends StatefulWidget {
  @override
  State<S2PM3P> createState() => _S2PM3PState();
}

class _S2PM3PState extends State<S2PM3P> {
  ...
  Future uploadFile() async {
    final path =
        "Aplicaciónes móviles/Tercer parcial/Semana 2/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Aplicaciónes móviles P3 - S2'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Aplicaciónes móviles/Tercer parcial/Semana 2/$fileName")
                        .putData(file!);
