...
class S1PM3P extends StatefulWidget {
  @override
  State<S1PM3P> createState() => _S1PM3PState();
}

class _S1PM3PState extends State<S1PM3P> {
  ...
  Future uploadFile() async {
    final path =
        "Aplicaciónes móviles/Tercer parcial/Semana 1/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Aplicaciónes móviles P3 - S1'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Aplicaciónes móviles/Tercer parcial/Semana 1/$fileName")
                        .putData(file!);
