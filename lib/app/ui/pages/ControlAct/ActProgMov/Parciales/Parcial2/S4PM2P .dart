...
class S4PM2P extends StatefulWidget {
  @override
  State<S4PM2P> createState() => _S4PM2PState();
}

class _S4PM2PState extends State<S4PM2P> {
  ...
  Future uploadFile() async {
    final path =
        "Aplicaciónes móviles/Segundo parcial/Semana 4/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Aplicaciónes móviles P1 - S4'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Aplicaciónes móviles/Segundo parcial/Semana 4/$fileName")
                        .putData(file!);
