...
class S5PM2P extends StatefulWidget {
  @override
  State<S5PM2P> createState() => _S5PM2PState();
}

class _S5PM2PState extends State<S5PM2P> {
  ...
  Future uploadFile() async {
    final path =
        "Aplicaciónes móviles/Segundo parcial/Semana 5/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Aplicaciónes móviles P1 - S5'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Aplicaciónes móviles/Segundo parcial/Semana 5/$fileName")
                        .putData(file!);
