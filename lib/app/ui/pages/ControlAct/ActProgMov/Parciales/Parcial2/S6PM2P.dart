...
class S6PM2P extends StatefulWidget {
  @override
  State<S6PM2P> createState() => _S6PM2PState();
}

class _S6PM2PState extends State<S6PM2P> {
  ...
  Future uploadFile() async {
    final path =
        "Aplicaciónes móviles/Segundo parcial/Semana 6/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Aplicaciónes móviles P1 - S6'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Aplicaciónes móviles/Segundo parcial/Semana 6/$fileName")
                        .putData(file!);
