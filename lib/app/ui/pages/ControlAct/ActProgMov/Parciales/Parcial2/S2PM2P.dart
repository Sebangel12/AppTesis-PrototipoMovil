...
class S2PM2P extends StatefulWidget {
  @override
  State<S2PM2P> createState() => _S2PM2PState();
}

class _S2PM2PState extends State<S2PM2P> {
  ...
  Future uploadFile() async {
    final path =
        "Aplicaciónes móviles/Segundo parcial/Semana 2/${pickedFile!.name}"; // ubicacion de almacenar el archivo
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Aplicaciónes móviles/Segundo parcial/Semana 2/$fileName")
                        .putData(file!);
