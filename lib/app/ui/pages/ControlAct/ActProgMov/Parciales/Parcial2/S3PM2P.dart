...
class S3PM2P extends StatefulWidget {
  @override
  State<S3PM2P> createState() => _S3PM2PState();
}

class _S3PM2PState extends State<S3PM2P> {
  ...
  Future uploadFile() async {
    final path =
        "Aplicaciónes móviles/Segundo parcial/Semana 3/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Aplicaciónes móviles P1 - S3'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Aplicaciónes móviles/Segundo parcial/Semana 3/$fileName")
                        .putData(file!);
