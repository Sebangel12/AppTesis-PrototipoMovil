...
class S6PM1P extends StatefulWidget {
  @override
  State<S6PM1P> createState() => _S6PM1PState();
}

class _S6PM1PState extends State<S6PM1P> {
  ...
  Future uploadFile() async {
    final path =
        "Aplicaciónes móviles/Primer parcial/Semana 6/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Aplicaciones Móviles P1 - S6'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Aplicaciónes móviles/Primer parcial/Semana 6/$fileName")
                        .putData(file!);
