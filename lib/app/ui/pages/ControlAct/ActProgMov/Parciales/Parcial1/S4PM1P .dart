...
class S4PM1P extends StatefulWidget {
  @override
  State<S4PM1P> createState() => _S4PM1PState();
}

class _S4PM1PState extends State<S4PM1P> {
  ...
  Future uploadFile() async {
    final path =
        "Aplicaciónes móviles/Primer parcial/Semana 4/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Aplicaciones Móviles P1 - S4'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Aplicaciónes móviles/Primer parcial/Semana 4/$fileName")
                        .putData(file!);
