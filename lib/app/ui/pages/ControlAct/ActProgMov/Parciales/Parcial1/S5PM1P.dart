...
class S5PM1P extends StatefulWidget {
  @override
  State<S5PM1P> createState() => _S5PM1PState();
}

class _S5PM1PState extends State<S5PM1P> {
  ...
  Future uploadFile() async {
    final path =
        "Aplicaciónes móviles/Primer parcial/Semana 5/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Aplicaciones Móviles P1 - S5'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Aplicaciónes móviles/Primer parcial/Semana 5/$fileName")
                        .putData(file!);
