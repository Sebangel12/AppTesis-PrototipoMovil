...
class S3PM1P extends StatefulWidget {
  @override
  State<S3PM1P> createState() => _S3PM1PState();
}

class _S3PM1PState extends State<S3PM1P> {
  ...
  Future uploadFile() async {
    final path =
        "Aplicaciónes móviles/Primer parcial/Semana 3/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Aplicaciones Móviles P1 - S3'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Aplicaciónes móviles/Primer parcial/Semana 3/$fileName")
                        .putData(file!);
