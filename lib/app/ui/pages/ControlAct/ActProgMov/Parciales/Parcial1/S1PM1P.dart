...
class S1PM1P extends StatefulWidget {
  @override
  State<S1PM1P> createState() => _S1PM1PState();
}

class _S1PM1PState extends State<S1PM1P> {
  ...
  Future uploadFile() async {
    final path =
        "Aplicaciónes móviles/Primer parcial/Semana 1/${pickedFile!.name}"; // ubicacion de almacenar el archivo
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Aplicaciónes móviles/Primer parcial/Semana 1/$fileName")
                        .putData(file!);
