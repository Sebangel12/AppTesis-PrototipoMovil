...
class S2BD2P extends StatefulWidget {
  @override
  State<S2BD2P> createState() => _S2BD2PState();
}

class _S2BD2PState extends State<S2BD2P> {
  ...
  Future uploadFile() async {
    final path =
        "Bases de datos/Segundo parcial/Semana 2/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Bases de Datos P2 - S2'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Bases de datos/Segundo parcial/Semana 2/$fileName")
                        .putData(file!);
