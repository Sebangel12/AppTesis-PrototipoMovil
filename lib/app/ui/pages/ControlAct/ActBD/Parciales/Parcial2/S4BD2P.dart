...
class S4BD2P extends StatefulWidget {
  @override
  State<S4BD2P> createState() => _S4BD2PState();
}

class _S4BD2PState extends State<S4BD2P> {
  ...
  Future uploadFile() async {
    final path =
        "Bases de datos/Segundo parcial/Semana 4/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Bases de Datos P2 - S4'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Bases de datos/Segundo parcial/Semana 4/$fileName")
                        .putData(file!);
