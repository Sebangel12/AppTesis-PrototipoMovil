...
class S6BD2P extends StatefulWidget {
  @override
  State<S6BD2P> createState() => _S6BD2PState();
}

class _S6BD2PState extends State<S6BD2P> {
  ...
  Future uploadFile() async {
    final path =
        "Bases de datos/Segundo parcial/Semana 6/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Bases de datos P1 - S6'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Bases de datos/Segundo parcial/Semana 6/$fileName")
                        .putData(file!);
