...
class S5BD2P extends StatefulWidget {
  @override
  State<S5BD2P> createState() => _S5BD2PState();
}

class _S5BD2PState extends State<S5BD2P> {
  ...
  Future uploadFile() async {
    final path =
        "Bases de datos/Segundo parcial/Semana 5/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Bases de Datos P2 - S5'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Bases de datos/Segundo parcial/Semana 5/$fileName")
                        .putData(file!);
