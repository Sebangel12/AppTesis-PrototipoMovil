...
class S1BD2P extends StatefulWidget {
  @override
  State<S1BD2P> createState() => _S1BD2PState();
}

class _S1BD2PState extends State<S1BD2P> {
  ...
  Future uploadFile() async {
    final path =
        "Bases de datos/Segundo parcial/Semana 1/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Bases de Datos P2 - S1'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Bases de datos/Segundo parcial/Semana 1/$fileName")
                        .putData(file!);
