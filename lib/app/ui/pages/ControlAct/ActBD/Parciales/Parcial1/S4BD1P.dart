...
class S4BD1P extends StatefulWidget {
  @override
  State<S4BD1P> createState() => _S4BD1PState();
}

class _S4BD1PState extends State<S4BD1P> {
  ...
  Future uploadFile() async {
    final path =
        "Bases de datos/Primer parcial/Semana 4/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Bases de datos P1 - S4'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Bases de datos/Primer parcial/Semana 4/$fileName")
                        .putData(file!);
