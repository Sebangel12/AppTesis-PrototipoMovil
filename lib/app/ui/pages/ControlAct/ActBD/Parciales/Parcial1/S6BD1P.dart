...
class S6BD1P extends StatefulWidget {
  @override
  State<S6BD1P> createState() => _S6BD1PState();
}

class _S6BD1PState extends State<S6BD1P> {
  ...
  Future uploadFile() async {
    final path =
        "Bases de datos/Primer parcial/Semana 6/${pickedFile!.name}"; // ubicacion de almacenar el archivo
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Bases de datos/Primer parcial/Semana 6/$fileName")
                        .putData(file!);
