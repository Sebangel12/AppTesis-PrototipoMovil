...
class S2BD1P extends StatefulWidget {
  @override
  State<S2BD1P> createState() => _S2BD1PState();
}

class _S2BD1PState extends State<S2BD1P> {
  ...
  Future uploadFile() async {
    final path =
        "Bases de datos/Primer parcial/Semana 2/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Bases de datos P1 - S2'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Bases de datos/Primer parcial/Semana 2/$fileName")
                        .putData(file!);
