...
class S5BD1P extends StatefulWidget {
  @override
  State<S5BD1P> createState() => _S5BD1PState();
}

class _S5BD1PState extends State<S5BD1P> {
  ...
  Future uploadFile() async {
    final path =
        "Bases de datos/Primer parcial/Semana 5/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Bases de datos P1 - S5'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Bases de datos/Primer parcial/Semana 5/$fileName")
                        .putData(file!);
