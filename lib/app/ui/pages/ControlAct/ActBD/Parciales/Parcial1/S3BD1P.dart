...
class S3BD1P extends StatefulWidget {
  @override
  State<S3BD1P> createState() => _S3BD1PState();
}

class _S3BD1PState extends State<S3BD1P> {
  ...
  Future uploadFile() async {
    final path =
        "Bases de datos/Primer parcial/Semana 3/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Bases de datos P1 - S3'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Bases de datos/Primer parcial/Semana 3/$fileName")
                        .putData(file!);
