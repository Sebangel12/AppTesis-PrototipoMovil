...
class S4BD3P extends StatefulWidget {
  @override
  State<S4BD3P> createState() => _S4BD3PState();
}

class _S4BD3PState extends State<S4BD3P> {
  ...
  Future uploadFile() async {
    final path =
        "Bases de datos/Tercer parcial/Semana 4/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Bases de Datos P3 - S4'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Bases de datos/Tercer parcial/Semana 4/$fileName")
                        .putData(file!);
