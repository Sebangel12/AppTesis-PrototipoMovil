...
class S3BD3P extends StatefulWidget {
  @override
  State<S3BD3P> createState() => _S3BD3PState();
}

class _S3BD3PState extends State<S3BD3P> {
  ...
  Future uploadFile() async {
    final path =
        "Bases de datos/Tercer parcial/Semana 3/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Bases de Datos P3 - S3'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Bases de datos/Tercer parcial/Semana 3/$fileName")
                        .putData(file!);
