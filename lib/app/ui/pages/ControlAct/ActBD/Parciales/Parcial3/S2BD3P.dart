...
class S2BD3P extends StatefulWidget {
  @override
  State<S2BD3P> createState() => _S2BD3PState();
}

class _S2BD3PState extends State<S2BD3P> {
  ...
  Future uploadFile() async {
    final path =
        "Bases de datos/Tercer parcial/Semana 2/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Bases de Datos P3 - S2'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Bases de datos/Tercer parcial/Semana 2/$fileName")
                        .putData(file!);
