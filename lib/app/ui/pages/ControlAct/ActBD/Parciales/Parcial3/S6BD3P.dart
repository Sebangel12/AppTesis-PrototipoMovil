...
class S6BD3P extends StatefulWidget {
  @override
  State<S6BD3P> createState() => _S6BD3PState();
}

class _S6BD3PState extends State<S6BD3P> {
  ...
  Future uploadFile() async {
    final path =
        "Bases de datos/Tercer parcial/Semana 6/${pickedFile!.name}"; // ubicacion de almacenar el archivo
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Bases de Datos P3 - S6'),
        ),
        body: Center(
          child: Column(
                ...
                onPressed: () async {
                  ...
                  if (result != null) {
                    ...
                    UploadTask task = FirebaseStorage.instance
                        .ref()
                        .child(
                            "Bases de datos/Tercer parcial/Semana 6/$fileName")
                        .putData(file!);
