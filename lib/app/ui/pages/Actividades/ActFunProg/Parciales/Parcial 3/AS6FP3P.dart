...
class AS6FP3P extends StatefulWidget {
  @override
  State<AS6FP3P> createState() => _AS6FP3PState();
}

class _AS6FP3PState extends State<AS6FP3P> {
  String dir = '/Fundamentos de programación/Tercer parcial/Semana 6';
