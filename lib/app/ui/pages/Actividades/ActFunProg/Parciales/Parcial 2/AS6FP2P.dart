...
class AS6FP2P extends StatefulWidget {
  @override
  State<AS6FP2P> createState() => _AS6FP2PState();
}

class _AS6FP2PState extends State<AS6FP2P> {
  String dir = '/Fundamentos de programación/Segundo parcial/Semana 6';
