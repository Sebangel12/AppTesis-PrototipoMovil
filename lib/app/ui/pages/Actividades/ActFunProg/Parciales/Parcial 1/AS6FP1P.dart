...
class AS6FP1P extends StatefulWidget {
  @override
  State<AS6FP1P> createState() => _AS6FP1PState();
}

class _AS6FP1PState extends State<AS6FP1P> {
  String dir = '/Fundamentos de programación/Primer parcial/Semana 6';
