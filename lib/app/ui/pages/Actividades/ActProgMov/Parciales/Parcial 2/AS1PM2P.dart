...
class AS1PM2P extends StatefulWidget {
  @override
  State<AS1PM2P> createState() => _AS1PM2PState();
}

class _AS1PM2PState extends State<AS1PM2P> {
  String dir = '/Aplicaciónes móviles/Segundo parcial/Semana 1';
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Aplicaciónes móviles P2 - S1'),
        ),
