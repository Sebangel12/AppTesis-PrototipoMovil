...
class AS3PM2P extends StatefulWidget {
  @override
  State<AS3PM2P> createState() => _AS3PM2PState();
}

class _AS3PM2PState extends State<AS3PM2P> {
  String dir = '/Aplicaciónes móviles/Segundo parcial/Semana 3';
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Aplicaciónes móviles P2 - S3'),
        ),
