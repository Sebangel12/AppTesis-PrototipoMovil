...
class AS2PM2P extends StatefulWidget {
  @override
  State<AS2PM2P> createState() => _AS2PM2PState();
}

class _AS2PM2PState extends State<AS2PM2P> {
  String dir = '/Aplicaciónes móviles/Segundo parcial/Semana 2';
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Aplicaciónes móviles P2 - S2'),
        ),
