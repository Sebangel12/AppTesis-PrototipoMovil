...
class AS4PM2P extends StatefulWidget {
  @override
  State<AS4PM2P> createState() => _AS4PM2PState();
}

class _AS4PM2PState extends State<AS4PM2P> {
  String dir = '/Aplicaciónes móviles/Segundo parcial/Semana 4';
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Aplicaciónes móviles P2 - S4'),
        ),
