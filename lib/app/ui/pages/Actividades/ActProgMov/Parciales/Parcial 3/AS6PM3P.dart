...
class AS6PM3P extends StatefulWidget {
  @override
  State<AS6PM3P> createState() => _AS6PM3PState();
}

class _AS6PM3PState extends State<AS6PM3P> {
  String dir = '/Aplicaciónes móviles/Tercer parcial/Semana 6';
