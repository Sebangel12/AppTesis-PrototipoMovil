...
class AS1PM1P extends StatefulWidget {
  @override
  State<AS1PM1P> createState() => _AS1PM1PState();
}

class _AS1PM1PState extends State<AS1PM1P> {
  String dir = '/Aplicaciónes móviles/Primer parcial/Semana 1';
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Aplicaciónes móviles P1 - S1'),
        ),
