...
class AS6PM1P extends StatefulWidget {
  @override
  State<AS6PM1P> createState() => _AS6PM1PState();
}

class _AS6PM1PState extends State<AS6PM1P> {
  String dir = '/Aplicaciónes móviles/Primer parcial/Semana 6';
