...
class AS5PM1P extends StatefulWidget {
  @override
  State<AS5PM1P> createState() => _AS5PM1PState();
}

class _AS5PM1PState extends State<AS5PM1P> {
  String dir = '/Aplicaciónes móviles/Primer parcial/Semana 5';
