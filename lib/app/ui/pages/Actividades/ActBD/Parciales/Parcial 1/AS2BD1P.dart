...
class AS2BD1P extends StatefulWidget {
  @override
  State<AS2BD1P> createState() => _AS2BD1PState();
}

class _AS2BD1PState extends State<AS2BD1P> {
  String dir = '/Bases de datos/Primer parcial/Semana 2';
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Base de datos P1 - S2'),
        ),
