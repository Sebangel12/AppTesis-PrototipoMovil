...
class AS6BD1P extends StatefulWidget {
  @override
  State<AS6BD1P> createState() => _AS6BD1PState();
}

class _AS6BD1PState extends State<AS6BD1P> {
  String dir = '/Bases de datos/Primer parcial/Semana 6';
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Base de datos P1 - S6'),
        ),
