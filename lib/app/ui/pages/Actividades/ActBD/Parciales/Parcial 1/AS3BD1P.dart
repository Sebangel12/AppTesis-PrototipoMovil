...
class AS3BD1P extends StatefulWidget {
  @override
  State<AS3BD1P> createState() => _AS3BD1PState();
}

class _AS3BD1PState extends State<AS3BD1P> {
  String dir = '/Bases de datos/Primer parcial/Semana 3';
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Base de datos P1 - S3'),
        ),
