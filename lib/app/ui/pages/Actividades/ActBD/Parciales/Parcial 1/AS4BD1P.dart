...
class AS4BD1P extends StatefulWidget {
  @override
  State<AS4BD1P> createState() => _AS4BD1PState();
}

class _AS4BD1PState extends State<AS4BD1P> {
  String dir = '/Bases de datos/Primer parcial/Semana 4';
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Base de datos P1 - S4'),
        ),
