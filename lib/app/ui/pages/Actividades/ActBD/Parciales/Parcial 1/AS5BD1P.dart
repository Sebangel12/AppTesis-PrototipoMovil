...
class AS5BD1P extends StatefulWidget {
  @override
  State<AS5BD1P> createState() => _AS5BD1PState();
}

class _AS5BD1PState extends State<AS5BD1P> {
  String dir = '/Bases de datos/Primer parcial/Semana 5';
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Base de datos P1 - S5'),
        ),
