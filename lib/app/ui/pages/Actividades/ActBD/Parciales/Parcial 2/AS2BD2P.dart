...
class AS2BD2P extends StatefulWidget {
  @override
  State<AS2BD2P> createState() => _AS2BD2PState();
}

class _AS2BD2PState extends State<AS2BD2P> {
  String dir = '/Bases de datos/Segundo parcial/Semana 2';
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Base de datos P2 - S2'),
        ),
