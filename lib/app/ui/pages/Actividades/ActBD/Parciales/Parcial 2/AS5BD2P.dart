...
class AS5BD2P extends StatefulWidget {
  @override
  State<AS5BD2P> createState() => _AS5BD2PState();
}

class _AS5BD2PState extends State<AS5BD2P> {
  String dir = '/Bases de datos/Segundo parcial/Semana 5';
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Base de datos P2 - S5'),
        ),
