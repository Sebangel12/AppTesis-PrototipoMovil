...
class AS5BD3P extends StatefulWidget {
  @override
  State<AS5BD3P> createState() => _AS5BD3PState();
}

class _AS5BD3PState extends State<AS5BD3P> {
  String dir = '/Bases de datos/Tercer parcial/Semana 5';
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Base de datos P3 - S5'),
        ),
