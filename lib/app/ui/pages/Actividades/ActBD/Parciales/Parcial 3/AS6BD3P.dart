...
class AS6BD3P extends StatefulWidget {
  @override
  State<AS6BD3P> createState() => _AS6BD3PState();
}

class _AS6BD3PState extends State<AS6BD3P> {
  String dir = '/Bases de datos/Tercer parcial/Semana 6';
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Base de datos P3 - S6'),
        ),
