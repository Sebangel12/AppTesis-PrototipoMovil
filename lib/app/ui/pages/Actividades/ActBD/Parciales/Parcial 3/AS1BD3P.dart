...
class AS1BD3P extends StatefulWidget {
  @override
  State<AS1BD3P> createState() => _AS1BD3PState();
}

class _AS1BD3PState extends State<AS1BD3P> {
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Base de datos P3 - S1'),
        ),
