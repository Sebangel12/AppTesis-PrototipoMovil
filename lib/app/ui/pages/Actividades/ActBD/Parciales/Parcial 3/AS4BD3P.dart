...
class AS4BD3P extends StatefulWidget {
  @override
  State<AS4BD3P> createState() => _AS4BD3PState();
}

class _AS4BD3PState extends State<AS4BD3P> {
  String dir = '/Bases de datos/Tercer parcial/Semana 4';
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        appBar: AppBar(
          ...
          centerTitle: true,
          title: const Text('Base de datos P3 - S4'),
        ),
