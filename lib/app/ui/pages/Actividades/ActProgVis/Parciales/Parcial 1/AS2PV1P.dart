...
class AS2PV1P extends StatefulWidget {
  @override
  State<AS2PV1P> createState() => _AS2PV1PState();
}

class _AS2PV1PState extends State<AS2PV1P> {
  String dir = '/Programación visual/Primer parcial/Semana 2';
