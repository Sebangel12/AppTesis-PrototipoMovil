...
class AS6PV3P extends StatefulWidget {
  @override
  State<AS6PV3P> createState() => _AS6PV3PState();
}

class _AS6PV3PState extends State<AS6PV3P> {
  String dir = '/Programación visual/Tercer parcial/Semana 6';
