...
class AS1PV2P extends StatefulWidget {
  @override
  State<AS1PV2P> createState() => _AS1PV2PState();
}

class _AS1PV2PState extends State<AS1PV2P> {
  String dir = '/Programación visual/Segundo parcial/Semana 1';
