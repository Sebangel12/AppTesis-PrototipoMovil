...
class AS2PV2P extends StatefulWidget {
  @override
  State<AS2PV2P> createState() => _AS2PV2PState();
}

class _AS2PV2PState extends State<AS2PV2P> {
  String dir = '/Programación visual/Segundo parcial/Semana 2';
