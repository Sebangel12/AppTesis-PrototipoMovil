...
class AS6PV2P extends StatefulWidget {
  @override
  State<AS6PV2P> createState() => _AS6PV2PState();
}

class _AS6PV2PState extends State<AS6PV2P> {
  String dir = '/Programación visual/Segundo parcial/Semana 6';
